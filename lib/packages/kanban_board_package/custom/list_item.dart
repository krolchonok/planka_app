    ...
    return ValueListenableBuilder(
        ...
        child: GestureDetector(
          ...
          child: prov.board.isElementDragged &&
              ...
              : cardProv.isCurrentElementDragged(listIndex: widget.listIndex, itemIndex: widget.itemIndex)
                  ? Container() ///Empty placeholder at the original card position
                  : Container( ///container behind every card
                      margin: const EdgeInsets.only(bottom: 10),
